...
### Before ML and AI: Generative Arts

![bg left width:650](https://i0.wp.com/aljazaribook.com/wp-content/uploads/2019/08/Category-I-chapter-2-fig-39-p48_Topkapi_en.jpg?w=562&ssl=1)
...
## Submitted Projects Awaiting Decision

**ERC-1** European Research Council, Starting Grant. Multimodal Generative Modelling for Interpretable Movement-to-Audio Synthesis: MODA. Kıvanç Tatar (PI, Chalmers University of Technology and University of Gothenburg). 1.5 million Euro ≈16.4 million SEK.
</div>
...
**J7:** *Tatar, K., Ericson P., Cotton, K., Núñez  del Prado P. T., Batlle-Roca R., Cabrero-Daniel, B, Ljungblad S., Diapoulis G., Hussain J. A Shift In Artistic Practices through Artificial Intelligence. Scheduled for release in June 2024 at Leonardo Journal, MIT Press.
...
**C14:** Tatar, K., Cotton, K., Bisig, D. (2023). Sound Design Strategies for Latent Audio Space Explorations Using Deep Learning Architectures. In Proceedings of Sound and Music Computing 2023.
**C11:** Diapoulis G., Zannos I., Tatar, K., Dahlstedt P. (2022). Bottom-up live coding: Analysis of continuous interactions towards predicting programming behaviours. In Proceedings of New Interfaces for Music Expression Conference 2022.
**C10:** Bisig D., Tatar, K. (2021). Raw Music from Free Movements: Early Experiments in Using Machine Learning to Create Raw Audio from Dance Movements. Accepted to AI Music Creativity Conference 2021 (AIMC 2021).
